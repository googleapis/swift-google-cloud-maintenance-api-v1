# Google Cloud Client Libraries for Swift - Maintenance API
...
Add `swift-google-cloud-maintenance-api-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-maintenance-api-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudMaintenanceApiV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudMaintenanceApiV1 <target-name> --package swift-google-cloud-maintenance-api-v1
```
