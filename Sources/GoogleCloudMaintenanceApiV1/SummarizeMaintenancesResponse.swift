...
public struct SummarizeMaintenancesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The resulting summaries.
  public var maintenances: [MaintenanceSummary] = []
  ...
  /// Initialize a new instance of `SummarizeMaintenancesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SummarizeMaintenancesResponse().with { $0.maintenances = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let maintenances = CodingKeys(stringValue: "maintenances")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MaintenanceSummary].self, forKey: .maintenances) {
      self.maintenances = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.maintenances, forKey: .maintenances)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.maintenance.api.v1.SummarizeMaintenancesResponse"
  }
...
extension SummarizeMaintenancesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [MaintenanceSummary] {
